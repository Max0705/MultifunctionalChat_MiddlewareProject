...
import Tools.RoomItemViewHolder;
import Tools.RoomItemsAdapter;
//import com.rc.app.Launcher;
//import com.rc.components.*;
//import com.rc.db.model.Room;
//import com.rc.db.service.RoomService;
import Tools.RoomItem;
...
public class RoomsPanel extends ParentAvailablePanel
{
    ...
    private void initData()
    {
        ...
        item.setTimestamp(20180524);
        item.setTitle("mychat");
        //item.setTitle(room.getName());
        item.setType("family");
        //item.setType(room.getType());
        item.setLastMessage("goodbye");
